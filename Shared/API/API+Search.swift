...
extension API {
	func searchChannels(for searchTerm: String, page: Int = 1, pageSize: Int = 20) async throws -> [Channel] {
		let url = URL(string: "https://content.watchnebula.com/search/channel/video/?text=\(searchTerm)&page=\(page)&page_size=\(pageSize)")!
	...
	func searchVideos(for searchTerm: String, page: Int = 1, pageSize: Int = 20) async throws -> [Video] {
		let url = URL(string: "https://content.watchnebula.com/search/video/?text=\(searchTerm)&page=\(page)&page_size=\(pageSize)")!
