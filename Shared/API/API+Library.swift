...
extension API {
	func libraryVideos(page: Int, pageSize: Int = 20) async throws -> [Video] {
		let url = URL(string: "https://content.watchnebula.com/library/video/?page=\(page)&pageSize=\(pageSize)")!
	...
	func libraryChannels(page: Int, pageSize: Int = 20) async throws -> [Channel] {
		let url = URL(string: "https://content.watchnebula.com/library/video/channels/?page=\(page)&pageSize=\(pageSize)")!
